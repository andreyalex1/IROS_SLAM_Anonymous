...
#include <chrono>
#include <platform_bt/goal_pose.hpp>
#include <platform_bt/turn_inside.hpp>
#include <platform_bt/rotate_wheels.hpp>
#include <platform_bt/stop_robot.hpp>
#include <behaviortree_cpp_v3/bt_factory.h> 
#include <behaviortree_cpp_v3/action_node.h>
#include <behaviortree_cpp_v3/bt_factory.h>
#include <behaviortree_cpp_v3/control_node.h>
#include <platform_bt/bt_action_node.hpp>
...
int main(int argc, char **argv) {
  ...
  auto tree = factory.createTreeFromFile("./src/platform_bt/xml_tree/tree.xml");
